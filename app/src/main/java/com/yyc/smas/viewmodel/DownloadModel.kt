                        ...
                        .flatMap({ index ->
                            ...
                            just.flatMap({ jsonObject ->
                                ...
                                Flowable.fromCallable {
                                    ...
                                    bean.Author = jsonObject.optString("Author")
                                    bean.Editions_Year = jsonObject.optString("Editions_Year")
                                    bean.BorrowStatus = jsonObject.optInt("BorrowStatus")
                                    bean.StatusKey = jsonObject.optString("StatusKey")
                                    bean.Img = jsonObject.optString("Img")
                                    bean.StatusId = jsonObject.optString("StatusID")
                                    bean.scanTime = jsonObject.optString("ScanDate")
                                    bean.ids = jsonObject.optString("RoNo")
                                    bean.status = RFID_BOOK
                                    bean.RoNo = roNo
                                    bean.companyId = companyID
                        ...
                        .flatMap({ index ->
                            ...
                            just.flatMap({ jsonObject ->
                                ...
                                Flowable.fromCallable {
                                    ...
                                    bean.BorrowStatus = jsonObject.optInt("Borrowstatus")
                                    bean.StatusKey = jsonObject.optString("StatusKey")
                                    bean.LevelType = jsonObject.optString("LevelType")
                                    bean.BishopName = jsonObject.optString("BishopName")
                                    bean.ArchivesYear = jsonObject.optString("ArchivesYear")
                                    bean.Img = jsonObject.optString("Img")
                                    bean.StatusId = jsonObject.optString("StatusID")
                                    bean.ids = jsonObject.optString("RoNo")
                                    bean.status = RFID_ARCHIVES
                                    bean.RoNo = roNo
                                    bean.companyId = companyID
                                    bean.InventoryStatus = jsonObject.optInt("InventoryStatus")
                                    bean
